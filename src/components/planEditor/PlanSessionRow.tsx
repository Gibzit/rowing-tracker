      ...
      <div className="bg-[#1a2640] rounded-xl p-3 space-y-2">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-white/[0.06] bg-[#0f1b33] text-[#dae2fd] rounded-lg text-sm min-h-[44px] font-mono focus:ring-2 focus:ring-[#00d2ff]/40 focus:border-[#00d2ff]/40 outline-none transition-colors"
            autoFocus
          />
        </div>
        <div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2 border border-white/[0.06] bg-[#0f1b33] text-[#dae2fd] rounded-lg text-sm min-h-[60px] resize-y focus:ring-2 focus:ring-[#00d2ff]/40 focus:border-[#00d2ff]/40 outline-none transition-colors"
          />
        </div>
