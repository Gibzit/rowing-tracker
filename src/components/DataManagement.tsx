    ...
    <>
      <div className="px-4 py-2 flex gap-3 justify-center">
        <button
          ...
          className="text-[10px] font-bold uppercase tracking-wider text-gray-400 dark:text-[#5a6580] hover:text-teal-500 dark:hover:text-teal-400 transition-colors touch-manipulation"
        >
          Export backup
        </button>
        <span className="text-gray-300 dark:text-[#404b66]">|</span>
        <button
